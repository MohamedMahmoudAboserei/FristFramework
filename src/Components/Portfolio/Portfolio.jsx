...
export default function Portfolio() {
  ...
  return <>
      <section className="my-6 pt-10 pb-28">
        ...
        <div className="flex justify-center items-center justify-items-center align-middle gap-10 flex-wrap">
          {images.map((image, index) => (
            <div
              key={index}
              className="group w-3/12 max-lg:w-2/5 max-sm:w-11/12 rounded-lg relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30"
